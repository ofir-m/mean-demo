...
app.controller('MembersPageController', ['$scope', '$resource', '$routeParams', '$stateParams', 'Member', 'Members', 'Count','$state', function($scope, $resource,$routeParams, $stateParams,  Member, Members, Count,$state) {
